...
function render_inventory_search_shortcode() {
    ...
    <style>
        ...
        .inventory-search-component-wrapper {width:100%; position: relative; /* This is the key change */}
        .inventory-search-input { width:100%; padding: 5px; font-size: 1em; border-radius: 25px !important; border: 1px solid #ccc; }
